...
function autoBind(instance: object): void {
  ...
  Object.getOwnPropertyNames(proto).forEach((key) => {
    ...
    if (key !== "constructor" && typeof value === "function") {
      rec[key] = (value as (...args: unknown[]) => unknown).bind(instance);
    }
  });
}
...
class App {
  ...
  onCheckDebounce: (...args: never[]) => void;
  renderer!: Renderer;
  gl!: GL;
  camera!: Camera;
  scene!: Transform;
  ...
  onWheel(e: Event) {
    ...
    const delta = wheelEvent.deltaY || (wheelEvent as WheelEvent & { wheelDelta?: number }).wheelDelta || (wheelEvent as WheelEvent).detail;
